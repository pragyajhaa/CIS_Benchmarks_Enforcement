...
def check_account_lockout_policy():
    try:
        ...
        result = subprocess.run(['secedit', '/export', '/cfg', 'exported_policy.inf', '/areas', 'ACCOUNTLOCKOUT'], capture_output=True, text=True, check=True)
        ...
        if result.returncode == 0:
            ...
            for setting in ["LockoutBadCount", "LockoutDuration", "ResetLockoutCount"]:
